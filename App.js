  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        <Stack.Screen name="RecuperarSenha" component={RecuperarSenha} options={{headerTintColor: '#573FBA', headerTitle: 'Recuperar Senha', headerStyle: {backgroundColor: '#2B1D62'}, headerTitleStyle: {fontFamily: 'AveriaLibre-Regular', fontSize: 33, color: '#FFFFFF'}}} />
